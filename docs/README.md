...
| [decisions/2026-09-26-visual-regression-baselines.md](decisions/2026-09-26-visual-regression-baselines.md) | Why the graph pane is captured per fixture repository and once at a narrowed width, why native macOS WebKit through the real app and `app_host`, why zero tolerance and not Playwright's comparator, why vitest rather than `@playwright/test`, and the open question of whether GitHub's macOS runner draws the same pixels. |

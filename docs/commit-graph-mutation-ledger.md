...
| 54 | graph_input.rs | CapturedGraph::from_source | `    pub fn from_source(source: &GraphSource) -> Self {` → `    pub fn from_source(source: &GraphSource) -> Self {⏎        if true {⏎            return Default::default();⏎        }` | UNVIABLE | 2026-08-12 |

...
{#snippet commitCard(commit: CommitDetail)}
  <div style="min-width: 0;">
    ...
    <div style="display: flex; align-items: center; gap: var(--space-2); margin-top: var(--space-1); min-width: 0; font-size: 11px;">
      ...
      <span style="color: var(--fg-3); font-family: var(--font-mono); flex-shrink: 0;" use:exactDate={commit.author_timestamp}>{relativeLabel(commit.author_timestamp, currentMinute())}</span>
